...
export default class AdminPage extends Component {
  ...
  getBrands = () => {
    const url = process.env.REACT_APP_API_URL + "/attribute/brands";
  ...
  getConditions = () => {
    const url = process.env.REACT_APP_API_URL + "/attribute/condition";
                ...
                <Form.Control as="select">
                  ...
                  {this.state.brands &&
                    this.state.brands.map((brand, index) => {
                      return (
                        <option value={brand.brand_id} key={index}>
                          {brand.brand_name}
                        </option>
                      );
                    })}
                ...
                <Form.Control as="select">
                  ...
                  {this.state.conditions &&
                    this.state.conditions.map((condition, index) => {
                      return (
                        <option value={condition.condition_id} key={index}>
